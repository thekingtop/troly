...
import type { AnalysisReport, ApplicableLaw, LawArticle, UploadedFile, LitigationType, LegalLoophole } from '../types.ts';
import { MagicIcon } from './icons/MagicIcon.tsx';
import { explainLaw } from '../services/geminiService.ts';
...
export const ReportDisplay: React.FC<ReportDisplayProps> = ({ report, onClearSummary, litigationType, onUpdateUserLaws, caseSummary, clientRequestSummary }) => {
